...
DROP FUNCTION if exists indec.describe_despues_de_muestreo_ffrr(text, _frac integer, _radio integer);
create or replace function indec.describe_despues_de_muestreo_ffrr(esquema text, _frac integer, _radio integer)
 returns table (
